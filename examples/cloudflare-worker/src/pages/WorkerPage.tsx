      ...
      <main class="edge-shell">
        <section class="edge-hero">
          <div>
            ...
            <p class="edge-lede">
              Vue Server does not start from a Node-only server abstraction. The app compiles down
        ...
        <section class="edge-grid">
          <article class="edge-card">
            ...
            <p>
              ...
              a separate architecture. Vue Server keeps the app contract fetch-native from the
              beginning.
            </p>
          </article>
          <article class="edge-card">
