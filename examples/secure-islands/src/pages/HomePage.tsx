      ...
      <main class="secure-shell">
        <section class="hero-grid">
          <div>
            ...
            <p class="lede">
              Vuerend keeps route components on the server by default. This page is mostly plain
        ...
        <section class="story-grid">
          ...
          <article class="story-card">
            ...
            <p>
              Vuerend is for teams who want Vue as the templating and component model for
